...
def put_20000_tasks(put_times=300):
    ...
    print('start at line index {} ....'.format(line_index))
            ...
            while True:
                try:
                    ...
                    if r.status_code == 200 and r.json()['msg'] == 'success':
                        ...
                        print('push success,spend {}s,wait 30s push next...'.format(b-a))
                        time.sleep(30)
                        break

                    elif r.status_code == 200 and 'wait' in r.content:
                        b = time.time()
                        print('spend {}s , master is full sleep 400s to push again'.format(b-a))                    
                        time.sleep(400)
                    ...
                    b = time.time()
                    print('spend {}s ,something wrong,wait 10s push again ....\n'.format(b-a),e)                      
                    time.sleep(10)
